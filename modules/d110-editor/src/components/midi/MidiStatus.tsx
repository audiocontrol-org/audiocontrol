...
export function MidiStatus(): JSX.Element {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex items-center gap-2">
        ...
        />
        <span className="text-sm text-d110-muted">{statusText[status]}</span>
      </div>
      {status === 'connected' && selectedInput && selectedOutput && (
        <div className="text-xs text-d110-muted hidden sm:block">
