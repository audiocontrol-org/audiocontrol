/**
 * Shared directory operations spec for library e2e tests.
 *
 ...
 *
 * These tests navigate to BASE_URL for OPFS access. They exercise
...
test.describe(`${EDITOR_NAME} Directory Operations`, () => {
