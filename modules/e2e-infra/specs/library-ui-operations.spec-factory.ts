/**
 * Shared library UI operations spec factory for e2e tests.
 *
 * Extracted from roland-sxx0-editor/e2e/library-ui-operations.spec.ts.
...
export function registerUIOperationsTests(config: LibraryTestConfig): void {
  test.describe(`${config.editorName} Library UI Operations`, () => {
