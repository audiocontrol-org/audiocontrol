...
```bash
npm install -g @audiocontrol/sampler-backup
```
...
pnpm --filter @audiocontrol/sampler-backup build
```
...
Delegates to the unified configuration system. See [@audiocontrol/audiotools-config](../audiotools-config/README.md) for details.
...
- **[@audiocontrol/sampler-export](../sampler-export/README.md)** - Disk image extraction and format conversion
- **[@audiocontrol/sampler-devices](../sampler-devices/README.md)** - Akai device abstraction
...
**Related Projects:**
- [@audiocontrol/sampler-export](https://www.npmjs.com/package/@audiocontrol/sampler-export) - Disk image extraction and format conversion
- [@audiocontrol/sampler-devices](https://www.npmjs.com/package/@audiocontrol/sampler-devices) - Akai device abstraction
