...
```typescript
import { createMidiSystem } from "@audiocontrol/sampler-midi";
...
```typescript
import { MidiSystem, EasyMidiBackend } from "@audiocontrol/sampler-midi";
...
```typescript
import { Midi } from "@audiocontrol/sampler-midi";
...
import { MidiSystem } from "@audiocontrol/sampler-midi";
import type { MidiBackend } from "@audiocontrol/sampler-midi";
...
```bash
npm install @audiocontrol/sampler-midi
```
