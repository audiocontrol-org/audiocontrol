/**
 * SCSI MIDI bridge e2e tests for Velocity Zones within Keygroups on Akai S3000XL.
 *
...
test.describe('S3000XL Velocity Zones (SCSI)', () => {
  ...
  test.describe('Zone Round-Trip', () => {
     ...
     */
    test('zone 2 tuning offset round-trip persists to device', async ({ page }) => {
      test.setTimeout(60_000);
