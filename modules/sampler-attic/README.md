...
# OR:  import { foo } from '@audiocontrol/sampler-lib'
...
pnpm add @audiocontrol/sampler-export @audiocontrol/sampler-translate
...
- `@audiocontrol/sampler-lib` - Core utilities and types
- `@audiocontrol/sampler-export` - Disk extraction functionality
- `@audiocontrol/sampler-translate` - Format conversion
- `@audiocontrol/sampler-backup` - Backup operations
- `@audiocontrol/sampler-devices` - Device abstractions
- `@audiocontrol/sampler-midi` - MIDI communication
