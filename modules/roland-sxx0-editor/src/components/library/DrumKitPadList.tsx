  ...
  return (
    <div className="space-y-3" data-testid="pad-list">
      ...
      {[...padsByKit.entries()].map(([kitNumber, kitPads]) => {
        ...
        return (
          <div key={kitNumber} className="bg-s330-bg rounded p-3 text-sm">
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        ...
                        'bg-s330-bg hover:bg-s330-muted/20 text-s330-text',
                    ...
                    <span className="w-16 text-s330-muted">
                      {formatDrumType(pad.drumType)}
                    </span>
                    {pad.sample ? (
                      <span className="flex-1 truncate text-s330-text">
                        {pad.sample}
                      </span>
                    ) : bundle.slices?.[pad.sliceIndex] ? (
                      <span className="flex-1 text-s330-muted">
                        {(
