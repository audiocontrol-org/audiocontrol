...
- User successfully tested with `@audiocontrol/launch-control-xl3@1.20.18-alpha.0`

**Evidence against hypothesis 1:**
- User specifically installed alpha.0: `@audiocontrol/launch-control-xl3@1.20.18-alpha.0`
...
npm install @audiocontrol/launch-control-xl3@1.20.18-alpha.1
