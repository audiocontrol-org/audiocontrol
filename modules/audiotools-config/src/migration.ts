 ...
 * @example
 * ```typescript
 * import { migrateConfig, loadConfig, saveConfig } from '@audiocontrol/audiotools-config';
 *
 ...
 * @example
 * ```typescript
 * import { hasDeviceIdentifier } from '@audiocontrol/audiotools-config';
 *
 * const source = {
 *   name: 's5k-card',
 *   type: 'local',
 ...
 * @example
 * ```typescript
 * import { getDeviceIdentifier } from '@audiocontrol/audiotools-config';
 *
 * const source = {
 *   name: 's5k-card',
 *   type: 'local',
