...
export function MidiStatusDisplay({
  ...
  return (
    <div className="ac-status-indicator">
      ...
      <span className="ac-status-label ac-hide-narrow" data-status={status}>
      ...
      <svg className="ac-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ opacity: 0.5 }}>
