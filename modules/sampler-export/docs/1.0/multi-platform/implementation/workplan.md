...
jobs:
  test-macos-intel:
    ...
    steps:
      ...
      - run: pnpm install
      - run: pnpm --filter @audiocontrol/sampler-export build
      - run: pnpm --filter @audiocontrol/sampler-export test
...
```bash
# Bump version
pnpm --filter @audiocontrol/sampler-export version patch

# Build
pnpm --filter @audiocontrol/sampler-export build

# Publish
pnpm --filter @audiocontrol/sampler-export publish
```
