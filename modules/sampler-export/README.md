...
```bash
npm install -g @audiocontrol/sampler-export
```
...
If you installed `@audiocontrol/audiotools`, you can use the unified CLI:
...
See [@audiocontrol/audiotools-config](../audiotools-config/README.md) for configuration API documentation.
...
- **[@audiocontrol/audiotools](../audiotools-cli/README.md)** - Unified CLI for all audio-tools
- **[@audiocontrol/audiotools-config](../audiotools-config/README.md)** - Shared configuration system
- **[@audiocontrol/sampler-backup](../sampler-backup/README.md)** - Backup system for sampler disk images
- **[@audiocontrol/sampler-devices](../sampler-devices/README.md)** - Akai device abstraction and binary parsing
- **[@audiocontrol/sampler-lib](../sampler-lib/README.md)** - Akai file format utilities
...
**Related Projects:**
- [@audiocontrol/sampler-backup](https://www.npmjs.com/package/@audiocontrol/sampler-backup) - Backup system for sampler disk images
- [@audiocontrol/sampler-devices](https://www.npmjs.com/package/@audiocontrol/sampler-devices) - Akai device abstraction and binary parsing
- [@audiocontrol/sampler-lib](https://www.npmjs.com/package/@audiocontrol/sampler-lib) - Akai file format utilities
