...
Complete documentation for the `@audiocontrol/sampler-translate` package version 1.0.
...
- `@audiocontrol/sampler-lib` (sample manipulation)
- `@audiocontrol/sampler-devices` (Akai format handling)

## Package Relationships

Depends on:
- `@audiocontrol/sampler-lib` - Sample processing, MIDI utilities
- `@audiocontrol/sampler-devices` - Akai device abstractions
