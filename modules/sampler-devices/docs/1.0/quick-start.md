...
```typescript
import {newAkaitools, AkaiToolsConfig} from '@audiocontrol/sampler-devices/s3k';
...
```typescript
import {parseS56kChunk, BasicProgram, Chunk} from '@audiocontrol/sampler-devices/s5k';
