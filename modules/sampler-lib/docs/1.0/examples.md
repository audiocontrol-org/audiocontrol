...
```typescript
import { newSampleFromBuffer } from '@audiocontrol/sampler-lib';
...
```typescript
import { AkaiDisk, AkaiRecordType } from '@audiocontrol/sampler-lib';
...
```typescript
import { parseNote, C3 } from '@audiocontrol/sampler-lib';
...
```typescript
import { newStreamOutput, ProcessOutput } from '@audiocontrol/sampler-lib';
...
```typescript
import { bytes2numberLE, nibbles2byte } from '@audiocontrol/sampler-lib';
