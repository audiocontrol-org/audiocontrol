...
- [ ] **Correct version:** Run `npm ls @audiocontrol/launch-control-xl3` (should show `1.20.18-alpha.0`)
...
1. **Ask user to verify package version:**
   ...
   node -e "console.log(require('@audiocontrol/launch-control-xl3/package.json').version)"
   ```
...
3. **Test with minimal example:**
   ```typescript
   import { CustomModeBuilder } from '@audiocontrol/launch-control-xl3';
