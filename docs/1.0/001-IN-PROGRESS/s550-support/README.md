...
|-----------|-------------|------------|
| **Phase 0: Frontend/Backend Decoupling** — **Task 10 IN PROGRESS.** | Tasks 1-9 done. Task 10 Waves 1/2a/2b/2c/3/4/5 complete (issues #411–#414 closed 2026-05-12; #415/#416 ready for closure). Wave 4 final close (commits `0a87d409` + `31f6fab6`): 15 of 15 capabilities bound. Wave 5 (commit `31f6fab6`): 4 of 4 DnD specs bound + production wiring added per operator-authorized scope expansion (`onExternalDrop` for device→library, panel-level sample drop on `DeviceMemoryPanel`). Wave 6 partial: 3 specs landed; remaining 3 D-XX-02/03/04 DT1-emit tests blocked on S-550 front-panel fixture capture. **143 specs passing.** [decisions-2026-05-11.md](./decisions-2026-05-11.md) v3 carries the remaining gating item (Decision 2; working assumption = Option B). | Blocks Phase 9 Task 4 (and therefore the redesign). |
