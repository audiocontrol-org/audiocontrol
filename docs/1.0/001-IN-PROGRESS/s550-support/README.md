...
|-----------|-------------|------------|
| **Phase 0: Frontend/Backend Decoupling** — **Task 10 INCOMPLETE.** | Tasks 1-9 done. Task 10 Wave 1 done (16 display capability specs). **Waves 2a/2b/2c/3/4/5/6 in scope and not done** — write coverage for 128 untested affordances. Per the workplan-discipline rule, these are not deferrable; they are in-scope-for-Task-10 work. The fact that they were filed as separate issues (#411–#417) does not change scope. | Blocks Phase 9 Task 4 (and therefore the redesign). |
