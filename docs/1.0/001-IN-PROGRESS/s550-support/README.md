...
|-----------|-------------|------------|
| **Phase 0: Frontend/Backend Decoupling** — **Task 10 IN PROGRESS.** | Tasks 1-9 done. Task 10 Waves 1/2a/2b/2c/3 complete (issues #411–#414 closed 2026-05-12). Wave 4 close-out shipped 2026-05-12 (commit `0a87d409` — 13 of 15 capabilities bound; D-LIB-12/13/17/18/19 added via fixture-copy seeding helpers per Decision 3; remaining D-LIB-14/21 wait on Wave 5 DnD). Wave 5 (4 DnD specs) sequenced next per Decision 4 = Option A. Wave 6 partial (3 specs landed; remaining 3 D-XX-02/03/04 DT1-emit tests blocked on S-550 front-panel fixture capture). 137 specs passing. [decisions-2026-05-11.md](./decisions-2026-05-11.md) v3 carries the remaining gating item (Decision 2; working assumption = Option B). | Blocks Phase 9 Task 4 (and therefore the redesign). |
