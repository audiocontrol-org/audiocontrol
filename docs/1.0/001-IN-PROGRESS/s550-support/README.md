...
|-----------|-------------|------------|
| **Phase 0: Frontend/Backend Decoupling** — **Task 10 IN PROGRESS.** | Tasks 1-9 done. Task 10 Waves 1/2a/2b/2c/3 complete (132 specs passing). Wave 4 partial (15 of 22 specs; remaining 7 blocked on Decision 3 library-seeding approach). Wave 5 (~6 DnD specs) sequenced after Decision 3. Wave 6 partial (3 of 7 specs; remaining 4 D-XX-02/03/04 DT1-emit tests blocked on S-550 front-panel fixture capture). [decisions-2026-05-11.md](./decisions-2026-05-11.md) v2 carries the gating operator items. | Blocks Phase 9 Task 4 (and therefore the redesign). |
