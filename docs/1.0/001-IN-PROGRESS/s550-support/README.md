...
**Status:** In Progress. Phases 1-8, 10 Complete; Phase 7 + Phase 9 Complete (2026-05-12); Phase 0 Task 10 Complete (all 7 waves). **2026-05-13 closeout pass:** 13 follow-up issues closed — 9 bookkeeping (fixes had previously landed but issues weren't closed: #392/#393/#396/#397/#399/#400/#401/#402/#403) + 4 small refactors with code (#420 1,293-LOC orphan deletion, #419 TreeSection testid, #418 LibraryTreeNode meta packing, #405 PatchesPage tone-load decoupling). **2026-05-13 evening:** [#408](https://github.com/audiocontrol-org/audiocontrol/issues/408) Tone Editor polish closed via 4 commits (`447a7dfd` + `2e64b6d0` + `e8a404db` + `3fa19358`): 5 new tone-editor controls (Wave Bank / Segment Top / Segment Length / Loop Tune / Env Zoom) + 1 data-model dedup (`tvaLfoDepth` alias collapsed onto `tva.lfoDepth` — fixed a silent-edit-drop bug at the encoder boundary). New `synthesize-tone-fixture.ts` tool ships codec-driven fixture regeneration so capability tests for codec changes can land without hardware. Follow-up [#422](https://github.com/audiocontrol-org/audiocontrol/issues/422) tracks the unexplored `TVA_LFO_DEPTH_2` codec parameter. `make test-ui-roland`: 175 passed, 4 skipped (170 → 175 with +5 capability specs). [decisions-2026-05-11.md](./decisions-2026-05-11.md) v3 — 5 of 6 decisions settled (Decision 2 remains; working assumption = Option B). See [`.claude/rules/agent-discipline.md`](/Users/orion/work/audiocontrol-work/audiocontrol-s550-support/.claude/rules/agent-discipline.md) for the workplan-discipline rules (4th rule canonized 2026-05-12 — "When CI is absent, the controller is the gate").
