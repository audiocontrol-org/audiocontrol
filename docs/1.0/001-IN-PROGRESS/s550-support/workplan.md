...
- [x] The resulting verification model has been promoted to a top-level project standard instead of remaining feature-local only. (Landed via `UI-CONTRACT-AND-VERIFICATION-STANDARD.md`, with matching pointers in `AGENTS.md`, `.claude/CLAUDE.md`, and this feature's simplification proposal.)
