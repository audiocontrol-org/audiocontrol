...
| Phase 5: LCXL3 multi-input | In design | LCXL3 as a second input source alongside MC-500. PRD + workplan updated with Phase 5; sub-phases 5a–5e enumerated. `--lcxl3-activate` one-shot CLI mode shipped (validates handshake on hardware). Implementation work pending. |
