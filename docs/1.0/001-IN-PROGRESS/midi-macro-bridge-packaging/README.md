...
| 7 | macOS `.app` + `.dmg` distribution (signed + notarized; native AppKit window via wry/tao hosting the existing web UI; no Terminal install required) | Code complete; v0.2.0 release pending operator authorization ([#367](https://github.com/audiocontrol-org/audiocontrol/issues/367); spec [`2026-05-05-macos-app-distribution-design.md`](2026-05-05-macos-app-distribution-design.md)) |
