...
| 11 | Built-in HELP screen — bridge configuration + LUNA / Logic Pro / Ableton Live DAW setup; macOS Help menu with Cmd-? accelerator (v0.4.0) | Not started ([#390](https://github.com/audiocontrol-org/audiocontrol/issues/390)) |
