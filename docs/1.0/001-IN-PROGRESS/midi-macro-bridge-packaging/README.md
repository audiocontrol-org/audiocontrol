...
| 8 | Mac-app polish — status bar icon, single-instance lock, macOS app menubar, brand mark | Complete; [v0.3.0 shipped](https://github.com/audiocontrol-org/audiocontrol/releases/tag/v0.3.0) ([#381](https://github.com/audiocontrol-org/audiocontrol/issues/381); resolves [#368](https://github.com/audiocontrol-org/audiocontrol/issues/368), [#369](https://github.com/audiocontrol-org/audiocontrol/issues/369), [#376](https://github.com/audiocontrol-org/audiocontrol/issues/376)) |
...
| 10 | Window-management polish — Cmd-1 Show Main Window + in-app Preferences (v0.3.2) | Not started ([#385](https://github.com/audiocontrol-org/audiocontrol/issues/385); resolves [#383](https://github.com/audiocontrol-org/audiocontrol/issues/383), [#384](https://github.com/audiocontrol-org/audiocontrol/issues/384)) |
