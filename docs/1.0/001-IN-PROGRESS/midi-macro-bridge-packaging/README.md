...
| 8 | Mac-app polish — status bar icon, single-instance lock, macOS app menubar, brand mark (v0.3.0) | Code complete; combined release with Phase 9 pending ([#381](https://github.com/audiocontrol-org/audiocontrol/issues/381); resolves [#368](https://github.com/audiocontrol-org/audiocontrol/issues/368), [#369](https://github.com/audiocontrol-org/audiocontrol/issues/369), [#376](https://github.com/audiocontrol-org/audiocontrol/issues/376)) |
| 9 | v0.2.1 polish — remove HALT button, wire `CARGO_PKG_VERSION` into UI, fix `update-homebrew-formula.sh` regex | Not started ([#380](https://github.com/audiocontrol-org/audiocontrol/issues/380); resolves [#377](https://github.com/audiocontrol-org/audiocontrol/issues/377), [#378](https://github.com/audiocontrol-org/audiocontrol/issues/378), [#379](https://github.com/audiocontrol-org/audiocontrol/issues/379)) |
