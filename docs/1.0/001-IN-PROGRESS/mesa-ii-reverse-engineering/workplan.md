...
- [ ] **Optional Step 0.5 (task #32): Path A.8 — decode JSR 0x272a4 + vtable[+0xA8].** Identifies the actual SRAW data handler. 1-2 hours of agent work. High value before harness scope finalization (likely identifies the function whose body emits SRAW wire bytes). Optional — P1 can also discover this through execution.
