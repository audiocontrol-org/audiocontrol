...
const ALL_SCENARIOS: ReadonlyArray<() => Promise<ScenarioResult>> = [
  ...
  // Named-import filter — files importing the canonical OR a transitive
  // wrapper (e.g., SteppedProgressDrawer wraps SlideDrawer) count as
  // adopters via the optional `imports:` field.
  ...IMPORTS_SCENARIOS,
